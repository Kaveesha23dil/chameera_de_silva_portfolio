          ...
          <div className="relative px-6 pt-10 sm:px-10 sm:pt-12 lg:px-16 lg:pt-14">
            ...
            <div className="grid grid-cols-1 gap-12 py-12 sm:grid-cols-2 lg:grid-cols-[1.45fr_0.85fr_1fr_0.9fr] lg:gap-14 lg:py-14">
              <div className="max-w-[310px]">
                ...
                <p className="mt-4 text-[11px] leading-5 text-slate-400">AI researcher, lecturer, and technology consultant creating intelligent solutions with meaningful real-world impact.</p>
            ...
            <div className="relative z-10 grid items-center gap-4 border-t border-white/[0.08] py-6 text-center text-[9px] text-slate-500 sm:grid-cols-[1fr_auto_1fr] sm:text-left">
